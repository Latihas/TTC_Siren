...
public class TriadGameModifierAllOpen : TriadGameModifier {
	...
	public static void StaticMakeKnown(TriadGameSimulationState gameData, List<int> redIndices) {
		...
		var deckRedEx = gameData.deckRed as TriadDeckInstanceManual;
...
public class TriadGameModifierSuddenDeath : TriadGameModifier {
	...
	public override void OnAllCardsPlaced(TriadGameSimulationState gameData) {
		if (gameData is { state: ETriadGameState.BlueDraw, numRestarts: < 3 }) {
			...
			var deckBlueEx = gameData.deckBlue as TriadDeckInstanceManual;
			var deckRedEx = gameData.deckRed as TriadDeckInstanceManual;
			if (deckBlueEx != null && deckRedEx != null) {
				var blueCards = new List<TriadCard>();
				var redCards = new List<TriadCard>();
				var redUnknownCards = new List<TriadCard>();
				var redCardsDebug = "";
...
public class TriadGameModifierDB {
	...
	private static TriadGameModifierDB instance = new();
