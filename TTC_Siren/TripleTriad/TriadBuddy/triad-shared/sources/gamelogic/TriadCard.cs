...
public class TriadCard : IEquatable<TriadCard> {
	...
	public string ToShortCodeString() => "[" + Id + ":" + Name.GetCodeName() + "]";

	public string ToShortLocalizedString() => "[" + Id + ":" + Name.GetLocalized() + "]";

	public string ToLocalizedString() => string.Format("[{0}] {1} {2} [{3}, {4}, {5}, {6}]",
...
public class TriadCardInstance {
	...
	public override string ToString() => owner + " " + card +
