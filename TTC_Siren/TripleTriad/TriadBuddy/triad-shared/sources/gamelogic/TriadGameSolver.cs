...
public struct SolverResult {
	...
	public static SolverResult Zero = new(0, 0, 0);
	...
	public bool IsBetterThan(SolverResult other) => score > other.score;

	public override string ToString() => $"{expectedResult}, score:{score}, win:{winChance:P0} ({numWins:0.##}/{numGames}), draw:{drawChance:P0} ({numDraws:0.##}/{numGames})";
}
