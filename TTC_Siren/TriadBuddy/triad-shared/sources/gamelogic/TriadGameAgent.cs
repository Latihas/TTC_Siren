...
public abstract class TriadGameAgentGraphExplorer : TriadGameAgent {
	...
	protected static bool IsFinished(TriadGameSimulationState gameState, out SolverResult gameResult) {
...
public class TriadGameAgentCarloScored : TriadGameAgentCarloTheExplorer {
	...
	public static float CalculateStateScore(TriadGameSolver solver, TriadGameSimulationState gameState) {
	...
	private static (float, float) CalculateBoardScore(TriadGameSolver solver, TriadGameSimulationState gameState) {
		// for each blue card:
		//   for each side:
	...
	private static float CalculateBlueDeckScore(TriadGameSolver solver, TriadGameSimulationState gameState) {
	...
	private static bool CanBeCapturedWith(TriadGameSimulation simulation, int defendingNum, int capturingNum) {
